...
public class ExtNetConverter {
	...
	public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
		...
		try {
			...
			Net   net          = new Net();
	    	net.setName("CongestiveHeartFailure");
	    	
	    	Node disease  = new Node ("CongestiveHeartFailure", "AtRisk, NotAtRisk",    net);
	    	Node tempID = null;
	    	Node tempnode = null;
	    	...
	    	for (String key : map.keySet()) {
	    		 ...
	    		 if(key.equals("HeartDiseases")){
				     ...
				     //setMarginal = new GetMarginalProb("50patients.xls", key);
...
//        	CPTconstruction setcpt;
			...
			Streamer stream = new Streamer ("CongestiveHeartFailure.dne");
                net.write(stream);
